...
<%-- 						value="${sessionScope.loginid }" readonly><br /> 난이도 <input --%>
<!-- 						type="radio" id="diff1" name="difficulty" value="★">★ <input -->
<!-- 						type="radio" id="diff2" name="difficulty" value="★★">★★ <input -->
<!-- 						type="radio" id="diff3" name="difficulty" value="★★★">★★★ -->
<!-- 					<input type="radio" id="diff4" name="difficulty" value="★★★★">★★★★ -->
<!-- 					<input type="radio" id="diff5" name="difficulty" value="★★★★★">★★★★★ -->
<!-- 					카테고리 <input type="radio" id="cate1" name="cate" value="한식">한식 -->
<!-- 					<input type="radio" id="cate2" name="cate" value="양식">양식 <input -->
<!-- 						type="radio" id="cate3" name="cate" value="일식">일식 <input -->
<!-- 						type="radio" id="cate4" name="cate" value="중식">중식 <input -->
<!-- 						type="radio" id="cate5" name="cate" value="기타">기타<br /> -->



<!-- 					<tr> -->
<!-- 						<th>difficulty</th> -->
<!-- 						<td><input type="radio" id="diff1" name="difficulty" -->
...
<!-- 					<tr> -->
<!-- 						<th>cate</th> -->
<!-- 						<td><input type="radio" id="cate1" name="cate" value="한식">한식 -->
<!-- 							<input type="radio" id="cate2" name="cate" value="양식">양식 -->
<!-- 							<input type="radio" id="cate3" name="cate" value="일식">일식 -->
<!-- 							<input type="radio" id="cate4" name="cate" value="중식">중식 -->
<!-- 							<input type="radio" id="cate5" name="cate" value="기타">기타</td> -->
<!-- 					</tr> -->
...
<!-- 		대표 이미지 <input type="file" name=file> 재료 <input type="text" -->
<!-- 			name="title"><br /> -->
<!-- 		<textarea rows="10" cols="45" name="content" id="content"></textarea> -->
<!-- 		<br /> 레시피 <input type="file" name="file"><br /> -->
<!-- 		<div id=box> -->
