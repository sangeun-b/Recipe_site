...
<body>
	...
	<a href="/board/write" id="boardwrite" class="btn btn-primary" >글작성</a>
	</div>
	...
	<c:forEach var="b" items="${list }">
		<div style="border: 1px solid; float: left; width: 33%;" >
			<a href="/board/detail/${b.num }"><img
				src="/board/readimg/${b.img_path }" width="200" height="200"></a><br />
